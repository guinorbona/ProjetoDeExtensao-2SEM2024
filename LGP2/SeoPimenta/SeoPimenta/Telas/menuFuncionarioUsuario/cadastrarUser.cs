...
namespace SeoPimenta.Telas.menuFuncionarioUsuario
{
    public partial class cadastrarUser : Form
    {
        ...
        private void txtProduto_cadastrarUser_Click(object sender, EventArgs e)
        {
            status = 1;
            this.Close();
        ...
        private void txtFuncionario_cadastrarUser_Click(object sender, EventArgs e)
        {
            status = 2;
            this.Close();
            thread1 = new Thread(abrirJanela);
        ...
        private void txtFornecedor_cadastrarUser_Click(object sender, EventArgs e)
        {
            status = 3;
            this.Close();
            thread1 = new Thread(abrirJanela);
        ...
        private void dscProduto_cadastrarUser_Click(object sender, EventArgs e)
        {
            status = 1;
            this.Close();
            thread1 = new Thread(abrirJanela);
        ...
        private void dscFuncionario_cadastrarUser_Click(object sender, EventArgs e)
        {
            status = 2;
            this.Close();
            thread1 = new Thread(abrirJanela);
        ...
        private void dscFornecedor_cadastrarUser_Click(object sender, EventArgs e)
        {
            status = 3;
            this.Close();
            thread1 = new Thread(abrirJanela);
        ...
        private void iconProduto_cadastrarUser_Click(object sender, EventArgs e)
        {
            status = 1;
            this.Close();
            thread1 = new Thread(abrirJanela);
        ...
        private void iconFuncionario_cadastrarUser_Click(object sender, EventArgs e)
        {
            status = 2;
            this.Close();
            thread1 = new Thread(abrirJanela);
        ...
        private void iconFornecedor_cadastrarUser_Click(object sender, EventArgs e)
        {
            status = 3;
            this.Close();
            thread1 = new Thread(abrirJanela);
