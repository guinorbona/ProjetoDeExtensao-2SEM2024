...
namespace SeoPimenta.Telas.estoqueProduto
{
    public partial class visualizarProdutos : Form
    {
        ...
        private void txtFuncionario_visualizarProdutos_Click(object sender, EventArgs e)
        {
            status = 1;
            this.Close();
            thread1 = new Thread(abrirJanela);
        ...
        private void txtFornecedor_visualizarProdutos_Click(object sender, EventArgs e)
        {
            status = 2;
            this.Close();
            thread1 = new Thread(abrirJanela);
        ...
        private void dscFuncionario_visualizarProdutos_Click(object sender, EventArgs e)
        {
            status = 1;
            this.Close();
            thread1 = new Thread(abrirJanela);
        ...
        private void dscFornecedor_visualizarProdutos_Click(object sender, EventArgs e)
        {
            status = 2;
            this.Close();
            thread1 = new Thread(abrirJanela);
        ...
        private void iconProduto_visualizarProdutos_Click(object sender, EventArgs e)
        {
            status = 3;
            this.Close();
            thread1 = new Thread(abrirJanela);
        ...
        private void iconFuncionario_visualizarProdutos_Click(object sender, EventArgs e)
        {
            status = 2;
            this.Close();
            thread1 = new Thread(abrirJanela);
        ...
        private void iconFornecedor_visualizarProdutos_Click(object sender, EventArgs e)
        {
            status = 3;
            this.Close();
            thread1 = new Thread(abrirJanela);
